...
# v2.0
# add leaderboard.txt and players_score.txt
# leaderboard showing the table of top players (by the rating)
# rating is corelation between games played and wins by Bayesian average
# players_score.txt store players nicknames and their count of games and wins
